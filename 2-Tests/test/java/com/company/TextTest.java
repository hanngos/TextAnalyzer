...
class TextTest {
    ...
    void setFieldsTestString(ArgumentsAccessor argumentsAccessor) {
        try {
            text.setFields(argumentsAccessor.getString(0), view);
    ...
    @Test
    void countLastChar() {
        text.setFields("cat", view);
        assertEquals(text.countLastChar(), 1);
        text.setFields("Santa Claus is coming to town", view);
        assertEquals(text.countLastChar(), 3);
        text.setFields("", view);
        assertNotEquals(text.countLastChar(), 0);
        text.setFields(" ", view);
        assertNotEquals(text.countLastChar(), 0);
    }
