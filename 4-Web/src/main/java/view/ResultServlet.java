...
public class ResultServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (session == null) {
            ...
            printLastChar(model, out);
            printWordsInfo(model, out);
            printPalindromes(model, out);
            printDiacritics(model, out);
            out.println("</CENTER>");
            out.close();
        }
    }
     ...
     * @param out   PrintWriter object
     */
    private void printLastChar(Model model, PrintWriter out) {
     ...
     * @param out   PrintWriter object
     */
    private void printWordsInfo(Model model, PrintWriter out) {
        Statistics division = (a, b) -> setPrecision(((double) a * 100) / b);
     ...
     * @param out   PrintWriter object
     */
    private void printPalindromes(Model model, PrintWriter out) {
        Statistics division = (a, b) -> setPrecision(((double) a * 100) / b);
     ...
     * @param out   PrintWriter object
     */
    private void printDiacritics(Model model, PrintWriter out) {
        Statistics division = (a, b) -> setPrecision(((double) a * 100) / b);
